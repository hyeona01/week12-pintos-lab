...
vm_alloc_page_with_initializer(enum vm_type type, void* upage, bool writable,
	...
	if (spt_find_page(spt, upage) == NULL) {
		 ...
		 * TODO: should modify the field after calling the uninit_new. */
		 ...
		 /* page type에 따른 page_initializer를 등록하기 위해, page_initializer_func 타입을 임의로 정의하여 사용 */
		typedef bool (*page_initializer_func)(struct page*, enum vm_type, void*);
		page_initializer_func initializer;
		...
		/* page fault시 최초로 실행되는 루틴 지정
		1. initializer(page_initializer) 2. init(vm_initializer) */
...
vm_do_claim_page(struct page* page) {
	...
	/* VM_UNINIT: uninit_initialize | VM_ANON: anon_swap_in | VM_FILE: file_backed_swap_in */
